 ...
 * @author mengli
 */
@WebServlet(name = "Servletsipinvite", urlPatterns = {"/Servletsipinvite"})
public class Servletsipinvite extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
           ...
           // connect to DB2
            ...
            String query1= "select * from USER WHERE EMAIL='"+useremail+"'";
