...
@WebServlet(name = "Servletsipcomment", urlPatterns = {"/Servletsipcomment"})
public class Servletsipcomment extends HttpServlet {
		...
		try{
			...
			ResultSet rs1 = stmt1.executeQuery(query1);
                                                             while(rs1.next())
                                                             {
                                                                 ...
                                                                 String query2="SELECT *FROM SIPCOMMENT WHERE POSTID='"+postid+"'";
                                                              ...
                                                              request.getRequestDispatcher("sipcommentdisplay.jsp").forward(request,response);
